...
export default function Player() {
  ...
  return (
    <div className="flex flex-col xsm:flex-row items-center gap-4 text-white px-4">
      ...
      <div className="flex flex-col items-center gap-1 m-auto">
        ...
        <div className="flex items-center gap-5">
          ...
          <div
            ref={seekBg}
            onClick={seekSong}
            className="w-[30vw] lg:w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer"
          >
            <hr
              ref={seekBar}
